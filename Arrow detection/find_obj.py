...
def init_feature(name):
    ...
    if chunks[0] == 'sift':
        ...
        detector = cv.xfeatures2d.SIFT_create(800)
        norm = cv.NORM_L2
    elif chunks[0] == 'surf':
...
def explore_match(win, img1, img2, kp_pairs, status = None, H = None):
    ...
    cv.imshow(win, vis)
    # cv.imshow(win, cv.resize(vis,(wii,hii),interpolation=cv.INTER_CUBIC))
    # cv.resizeWindow(win, wii,hii)
    ...
    def onmouse(event, x, y, flags, param):
        ...
        # cv.imshow(win, cv.resize(cur_vis,(wii,hii),interpolation=cv.INTER_CUBIC))
        # cv.resizeWindow(win, wii,hii)
...
def main():
    ...
    try:
        ...
        fn1 = '../customimages/arrow18.jpg'
        fn2 = '../customimages/arrow14.jpg'
